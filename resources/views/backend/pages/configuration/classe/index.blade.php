...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($data_classe as $key => $item)
                                    <tr id="row_{{ $item['id'] }}">
                                        <td> {{ ++$key }} </td>
                                        <td>{{ $item['status'] }}</td>
                                        <td>{{ $item['niveau']['cycle']['name'] }}</td>
                                        <td>{{ $item['niveau']['name'] }}</td>
                                        <td> {{ $item['name'] }}</td>
                                        <td>{{ $item['capacite_min'] }}</td>
                                    ...
                                    @include('backend.pages.configuration.classe.edit')
                                    @include('backend.pages.configuration.classe.position')
                                @endforeach
    ...
    @include('backend.pages.configuration.classe.create')

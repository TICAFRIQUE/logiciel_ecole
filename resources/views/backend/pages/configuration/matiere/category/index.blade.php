...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($data_matiere_category as $key => $item)
                                    <tr id="row_{{ $item['id'] }}">
                                        <td> {{ ++$key }} </td>
                                        <td>{{ $item['status'] }}</td>
                                        <td>
                                    ...
                                    @include('backend.pages.configuration.matiere.category.edit')
                                    @include('backend.pages.configuration.matiere.category.position')
                                @endforeach
    ...
    @include('backend.pages.configuration.matiere.category.create')

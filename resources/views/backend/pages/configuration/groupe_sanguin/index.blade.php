...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($data_groupe_sanguin as $key => $item)
                                    <tr id="row_{{ $item['id'] }}">
                                        <td> {{ ++$key }} </td>
                                        <td> {{ $item['name'] }}</td>
                                        <td> {{ $item['position'] }} </td>
                                    ...
                                    @include('backend.pages.configuration.groupe_sanguin.edit')
                                    @include('backend.pages.configuration.groupe_sanguin.position')
                                @endforeach
    ...
    @include('backend.pages.configuration.groupe_sanguin.create')

...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($data_niveaux as $key => $item)
                                    <tr id="row_{{ $item['id'] }}">
                                        <td> {{ ++$key }} </td>
                                        <td>{{ $item['status'] }}</td>
                                        <td>{{ $item['cycle']['name'] }}</td>
                                        <td> {{ $item['name'] }}</td>
                                        <td>{{ number_format($item['montant_inscription'] , 0 , '.', ' ') }}</td>
                                        <td>{{number_format( $item['montant_scolarite'] , 0 , '.',' ') }}</td>
                                        <td>{{number_format( $item['total_scolarite'] , 0 , '.',' ') }}</td>
                                        <td>{{ $item['capacite'] }}</td>
                                        <td> {{ $item['position'] }} </td>
                                        <td>
                                    ...
                                    @include('backend.pages.configuration.niveau.edit')
                                    @include('backend.pages.configuration.niveau.position')
                                @endforeach
    ...
    @include('backend.pages.configuration.niveau.create')

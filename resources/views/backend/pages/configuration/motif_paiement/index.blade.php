...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($data_motif_paiement as $key => $item)
                                    <tr id="row_{{ $item['id'] }}">
                                        <td> {{ ++$key }} </td>
                                        <td>{{ $item['status'] }}</td>
                                        <td> {{ $item['name'] }}</td>
                                    ...
                                    @include('backend.pages.configuration.motif_paiement.edit')
                                    @include('backend.pages.configuration.motif_paiement.position')
                                @endforeach
    ...
    @include('backend.pages.configuration.motif_paiement.create')

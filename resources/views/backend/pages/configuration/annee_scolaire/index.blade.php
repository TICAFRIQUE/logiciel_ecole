...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="buttons-datatables" class="display table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($data_annee_scolaire as $key => $item)
                                    <tr id="row_{{ $item['id'] }}">
                                        <td> {{ ++$key }} </td>
                                        <td>{{ $item['status'] }}</td>
                                        <td> {{ $item['indice'] }}</td>
                                    ...
                                    @include('backend.pages.configuration.annee_scolaire.edit')
                                    @include('backend.pages.configuration.annee_scolaire.position')
                                @endforeach
    ...
    @include('backend.pages.configuration.annee_scolaire.create')

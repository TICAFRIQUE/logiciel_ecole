         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post"
                     action="{{ route('annee-scolaire.update', $item['id']) }}" novalidate>
                     @csrf
                     <div class="col-md-12">
                         <label for="validationCustom01" class="form-label">Date debut</label>
                         <input type="date" name="date_debut" value="{{ $item['date_debut'] }}" class="form-control"
                     ...
                     <div class="col-md-12">
                        ...
                        <input type="date" name="date_fin" value="{{ $item['date_fin'] }}" class="form-control"
                            id="validationCustom01" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>

         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post"
                     action="<?php echo e(route('cycle.update', $item['id'])); ?>" novalidate>
                     <?php echo csrf_field(); ?>
                     <div class="col-md-12">
...
<?php /**PATH C:\laragon\www\logiciel_ecole\resources\views/backend/pages/configuration/cycle/edit.blade.php ENDPATH**/ ?>
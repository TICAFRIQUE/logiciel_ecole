         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post"
                     action="<?php echo e(route('matiere.position', $item['id'])); ?>" novalidate>
                     <?php echo csrf_field(); ?>
                     ...
                     <div class="col-md-12">
                         ...
                         <select name="position" class="form-control">
                             <?php for($i = 1; $i <= count($data_matiere); $i++): ?>
...
<?php /**PATH C:\laragon\www\logiciel_ecole\resources\views/backend/pages/configuration/matiere/matiere/position.blade.php ENDPATH**/ ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data_versement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="row_<?php echo e($item['id']); ?>"
                                    class="<?php echo e($item->deleted_at != null ? 'bg-danger text-white' : ''); ?>">
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li class="<?php echo e($item->deleted_at !=null ? 'd-block' : 'd-none'); ?> "  data-bs-toggle="modal" data-bs-target="#myModal<?php echo e($item->id); ?>">
                                                    <a href="#"

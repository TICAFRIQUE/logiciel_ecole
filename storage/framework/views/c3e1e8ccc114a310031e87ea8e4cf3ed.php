             ...
             <div class="modal-body">
                 <form class="needs-validation" novalidate method="POST"
                     ...
                     <div class="mb-3">
                         ...
                         <input type="text" value="<?php echo e($item['last_name']); ?>" name="last_name" class="form-control"
                             id="username" required>
                     </div>

                     <div class="mb-3">
                         <label for="username" class="form-label">Prenoms</label>
                         <input type="text" value="<?php echo e($item['first_name']); ?>" name="first_name" class="form-control"
                             id="username" required>
                     </div>
                     ...
                     <div class="mb-3">
                         ...
                         <input type="number" value="<?php echo e($item['phone']); ?>" name="phone" class="form-control"
                             id="username" required>
                     </div>
...
<?php /**PATH C:\laragon\www\logiciel_ecole\resources\views/backend/pages/auth-admin/register/edit.blade.php ENDPATH**/ ?>
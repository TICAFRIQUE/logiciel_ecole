            ...
            <div class="card mt-n5">
                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        ...
                        <p class="text-muted mb-0"> Classe Actuelle : <?php echo e(count($data_classe->inscriptions)>0 ? $data_classe->inscriptions[0]->classe->name : '??'); ?> </p>
                ...
                <div class="card-body p-4">
                    <div class="tab-content">
                        <div class="tab-pane active" id="HistoriqueScolarite" role="tabpanel">
                            ...
                            <?php echo $__env->make('backend.pages.reliquat.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

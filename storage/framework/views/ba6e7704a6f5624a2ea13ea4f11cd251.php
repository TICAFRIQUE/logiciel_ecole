         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post"
                     action="<?php echo e(route('annee-scolaire.update', $item['id'])); ?>" novalidate>
                     <?php echo csrf_field(); ?>
                     <div class="col-md-12">
                         <label for="validationCustom01" class="form-label">Date debut</label>
                         <input type="date" name="date_debut" value="<?php echo e($item['date_debut']); ?>" class="form-control"
                     ...
                     <div class="col-md-12">
                        ...
                        <input type="date" name="date_fin" value="<?php echo e($item['date_fin']); ?>" class="form-control"
                            id="validationCustom01" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
...
<?php /**PATH C:\laragon\www\logiciel_ecole\resources\views/backend/pages/configuration/annee_scolaire/edit.blade.php ENDPATH**/ ?>
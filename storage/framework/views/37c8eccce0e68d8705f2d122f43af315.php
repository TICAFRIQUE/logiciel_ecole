                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content ">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="row g-3 needs-validation" method="post" action="<?php echo e(route('eleve.store')); ?>"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="date" name="date_admission" value="<?php echo e($date_now); ?>"
...
<!--end row-->
<?php /**PATH C:\laragon\www\logiciel_ecole\resources\views/backend/pages/inscription/modal-create-eleve.blade.php ENDPATH**/ ?>
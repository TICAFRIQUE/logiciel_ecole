         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post"
                     action="<?php echo e(route('annee-scolaire.position', $item['id'])); ?>" novalidate>
                     <?php echo csrf_field(); ?>
                     ...
                     <div class="col-md-12">
                         ...
                         <select name="position" class="form-control">
                             <?php for($i = 1; $i <= count($data_annee_scolaire); $i++): ?>
...
<?php /**PATH C:\laragon\www\logiciel_ecole\resources\views/backend/pages/configuration/annee_scolaire/position.blade.php ENDPATH**/ ?>
         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form class="row g-3 needs-validation" method="post"
                     action="<?php echo e(route('mode-paiement.position', $item['id'])); ?>" novalidate>
                     <?php echo csrf_field(); ?>
                     ...
                     <div class="col-md-12">
                         ...
                         <select name="position" class="form-control">
                             <?php for($i = 1; $i <= count($data_mode_paiement); $i++): ?>
...
<?php /**PATH C:\laragon\www\logiciel_ecole\resources\views/backend/pages/configuration/mode_paiement/position.blade.php ENDPATH**/ ?>